...
public class MessageDAO {
    ...
    public Message deleteAMessageGivenMessageId(int id){
        ...
        try {
            ...
            preparedStatement.executeUpdate();
            //return message of deleted
            ResultSet pkeyResultSet = preparedStatement.getGeneratedKeys();
            if(pkeyResultSet.next()){
                return new Message(pkeyResultSet.getInt("message_id"), pkeyResultSet.getInt("posted_by"),
                pkeyResultSet.getString("message_text"), pkeyResultSet.getLong("time_posted_epoch"));
            }
        }catch(SQLException e){
            System.out.println(e.getMessage());
        }
